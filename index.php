...
<html lang="en">
  ...
  <title>Animali del bosco</title>
  
  <body>
    <h1 class="d-block p-2 bg-primary text-white">Animali del bosco</h1>
  </body>
   ...
   <p>    
    ...
    <div class="row">
        ...
        cui 15-20 centimetri di coda. Pesa all'incirca da 230-450 g. Ha un corpo agile, slanciato e abile nell'arrampicarsi sugli
        alberi.</p>
        </div class="col-md-6">
      <img src="img/scoiattolo.jpg" alt="scoiattolo">
    </div>
    ...
    forma e posizione dell'anno precedente ma con una ramificazione in più.
    Negli individui più deboli i palchi pesano 9-10 kg ma nei più vecchi possono pesare 16-18 kg, i cervi maschi si
    ...
    L'orso è onnivoro, cioè mangia di tutto dalla frutta alla carne al pesce. Mangia anche licheni, radici e bacche. È goloso
    di miele.
    </p>
<img src="img/orso1.jpg" alt="orso" align="right" width="200" height="150">
    <img src="img/orso2.jpg" alt="orso" align="right" width="200" height="150">
  ...
  <footer>
    <div class="container">
      <hr>
      <footer><em>Tratto da Wikijunior: gli animali del bosco - Wikibooks, manuali e libri di testo liberi.
      Jonathan Pagliaricci 2'A</em></footer>
    </div>
  </footer>
